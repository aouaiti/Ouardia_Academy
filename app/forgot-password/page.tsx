...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-primary-dark via-primary to-primary-light/30 p-4">
      <div className="w-full max-w-md rounded-2xl bg-surface p-8 shadow-xl">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-muted">Recevez un lien de réinitialisation par email</p>
        </div>
